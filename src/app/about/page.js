...
function Page() {
  return (
    <Fragment>
      ...
      <section className="px-14  w-full mt-5 flex items-center justify-center sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20">
        <div className="2xl:max-w-[1300px] w-full lg:relative">
          <div
            style={{
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20  text-center lg:text-start flex items-center justify-center  w-full">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-10 lg:flex-row lg:justify-between">
          ...
          <Image
            src={image_1}
            alt=""
            className="max-w-[400px] 2xl:max-w-[500px] w-full"
          ></Image>
        </div>
      </section>

      <section className="px-14 lg:p-0 w-full  text-center lg:text-start  md:p-0  flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center md:grid md:grid-cols-3">
          <div
            style={{
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 py-14 bg-[#F8F8F8] text-center flex items-center justify-center">
