...
function Page() {
  return (
    <Fragment>
      <Header></Header>
      <section className="text-center mb-20 mt-14 lg:text-start px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 flex flex-col items-center gap-10 lg:flex-row lg:items-start">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col items-center gap-4 lg:items-start lg:flex-row">
              ...
              <div className="flex flex-col items-center lg:items-start gap-2">
                <h4 className="text-[18px] font-medium">Convenient service</h4>
            ...
            <div className="flex flex-col items-center gap-4 lg:items-start lg:flex-row">
              ...
              <div className="flex flex-col items-center lg:items-start gap-2">
                <h4 className="text-[18px] font-medium">Transparent pricing</h4>
                <p className="text-[#939191] text-[14px]">
                  Through True Rich Attended does no end it his mother since
                  real had half every him.
                </p>
