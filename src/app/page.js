...
export default function Home() {
  ...
  return (
    <Fragment>
      <header className="flex items-center justify-center h-[10vh] w-full px-14  sm:px-16 md:px-20 lg:px-24 xl:px-28  py-10">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 mb-20 mt-5 transition-all text-center lg:text-start w-full flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-12 lg:flex-row lg:justify-between">
          ...
          <Image
            src={hero_image}
            alt=""
            className="max-h-[400px] w-full max-w-[600px] object-cover"
          ></Image>
        </div>
      </section>

      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 text-center lg:text-start w-full bg-[#E2E6E9] py-16 flex items-center justify-center mb-20">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-12 lg:gap-28 lg:flex-row lg:justify-between lg:items-start">
      ...
      <section className="px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 text-center lg:text-start w-full mb-20 flex items-center justify-center">
      ...
      <section className="bg-[#F2F2F2] transition-all py-16 px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 text-center w-full flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col gap-10">
          ...
          <div className="flex flex-col w-full items-center gap-8 md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <section className="bg-[#F2F2F2] mb-20 py-5 px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 text-center w-full flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-10 md:grid md:grid-cols-2 lg:flex lg:flex-row lg:justify-between">
          <div className="flex flex-col items-center gap-2">
      ...
      <section className="px-14 mb-20 sm:px-16 md:px-20 w-full lg:px-24 xl:px-28 flex items-center justify-center text-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-6">
      ...
      <section className="bg-[#F2F2F2] py-12 px-14 sm:px-16 md:px-20 w-full lg:px-24 xl:px-28 flex items-center justify-center">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col gap-10">
      ...
      <section className="py-12 px-14 sm:px-16 md:px-20 flex items-center justify-center w-full lg:px-24 xl:px-28 bg-[#E2E6E9]">
        <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center lg:justify-center gap-10">
      ...
      <footer className="bg-[#1E1B1B] w-full text-white flex items-center justify-center flex-col">
        <div className=" text-center lg:text-start py-12 px-14 sm:px-16 md:px-20 lg:px-24 xl:px-28 flex items-center justify-center  w-full ">
          <div className="w-full 2xl:max-w-[1300px] gap-10 lg:gap-40 lg:justify-between lg:items-start flex flex-col items-center lg:flex-row ">
        ...
        <div className="w-full bg-black text-white  px-14 sm:px-16 md:px-20 flex items-center justify-center lg:px-24 xl:px-28  py-5">
          <div className="w-full 2xl:max-w-[1300px] flex flex-col items-center gap-5 lg:flex-row lg:justify-between">
